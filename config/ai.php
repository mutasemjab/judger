...
TEXT
    ...
    'legal_keywords' => [
        ...
        'punishment', 'sentence', 'sentencing', 'murder', 'homicide', 'manslaughter',
        'felony', 'misdemeanor', 'prison', 'jail', 'imprisonment', 'death penalty',
        ...
        'جنائي', 'جناية', 'جنايه', 'جنحة', 'جنحه', 'جريمة', 'جريمه', 'عقوبة',
        'عقوبه', 'عقوبات', 'قتل', 'القتل', 'قتل عمد', 'القتل العمد', 'سجن',
        'حبس', 'إعدام', 'اعدام', 'قصاص', 'شرطة', 'قبض', 'كفالة', 'طلاق',
        'حضانة', 'ميراث', 'وصية',
