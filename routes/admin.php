...
Route::prefix('admin')->name('admin.')->group(function () {
    ...
    Route::middleware('admin_web')->group(function () {
        ...
        Route::post('/knowledge/openai-config', [AdminKnowledgeWebController::class, 'updateAiConfig'])->name('knowledge.openai-config');
        ...
        Route::post('/knowledge/{knowledgeDocument}/step', [AdminKnowledgeWebController::class, 'step'])->name('knowledge.step');
        Route::post('/knowledge/{knowledgeDocument}/stop', [AdminKnowledgeWebController::class, 'stop'])->name('knowledge.stop');
