...
<div class="login-wrapper">
    <div class="login-card" id="loginCard">
        ...
        <form action="<?php echo e(route('admin.login')); ?>" method="POST" novalidate>
            <?php echo csrf_field(); ?>
            ...
            <div>
                ...
                <div class="field-wrap">
                    <input type="text"
                           id="username"
                           name="username"
                           class="field-input <?php echo e($errors->has('username') ? 'has-error' : ''); ?>"
            ...
            <div>
                ...
                <div class="field-wrap">
                    <input type="password"
                           id="password"
                           name="password"
                           class="field-input with-toggle <?php echo e($errors->has('password') ? 'has-error' : ''); ?>"
...
<?php /**PATH C:\xampp\htdocs\rafeeq\resources\views/admin/auth/login.blade.php ENDPATH**/ ?>